!function(window, $, undefined) { !
    ...
    function() {
        ...
        if ($.isIE678) {
            ...
            $.fn.extend({
                _bind_: $.fn.bind,
                bind: function(e, i, m) { / ^click$ / gi.test(e) && d(this);
    ...
    $.fn.bindTab = function(e, i, m, t, n) {
        ...
        return this.each(function() {
            ...
            u && s.delegate(a, "mouseleave",
            function() {
                r && window.clearTimeout(r);
                r = 0
            });
            "a" == a && s.delegate(a, "click",
            function(e) {
                e.preventDefault()
            });
            var f = s.find("." + o[0]);
    ...
    function() {
        ...
        a = function(e, t, n, r, o) {
            ...
            if (i.test(l) && i.test(a) && l.indexOf(document.domain) >= 0 && "http:" == u) s(l,
            function(i) {
                c(i, e, t, n, r, o)
            });
    ...
    function() {
        ...
        window.URS = function(l, u, h) {
            ...
            if (h.cssDomain && h.cssFiles) {
                ...
                if ( - 1 != m.__cssStr.indexOf("http://")) window.PTDOM = "http://";
                m.__cssStr = encodeURIComponent(m.__cssStr)
            }
            ...
            var v = function() {
                ...
                var m = function() {
                    ...
                    return function() {
                        e = [];
                        if (s && s.length) for (var i = s.length,
                        t; i--; i >= 0) {
                            t = s[i];
                            m(t, i, s)
                        }
    ...
    function($) {
        ...
        var startAct = function() {
            ...
            login = function() {
                ...
                m = {
                    ...
                    checkOptions: function(e, t, n) {
                        ...
                        "object" != typeof e || $.isArray(e) || $.extend(s, e || {}),
                        s.successUrl = m.fillUrl(s.successUrl);
                        ...
                        return n === !0 ? s: (s.oauthLoginConfig = function(e) {
                            ...
                            return function(m, t) {
                                if ("giveup" === t) $.isFunction(i) && i();
                                    ...
                                    globalMsg.sendMsg("login.jump", m),
                                    document.URL.replace(/#.+$/g, "") === r.replace(/#.+$/g, "") ? window.location.reload(!0) : window.location.href = r
                                }
                            }
                ...
                r = function(e, i) {
                    ...
                    o = function(e, i) {
                        e.showIframe(i),
                        $(document).unbind("keydown", r.close),
                        $(document).keydown(r.close);
                        var m = $("#x-panel").css("z-index", 20020),
                        n = $("#x-discover").css("z-index", 20001);
                        t.ursInit && t.ursInit(m, n)
                    };
                    if (m.urs) return m._callback = n.callback,
                    void o(m.urs, n);
                    var a = new URS(n);
                    m._callback = n.callback,
                    m.urs = a,
                    a.logincb = s("onLogin",
                    function(e) {
                        m.ursId = e,
                        m._callback(e, "login"),
                        globalMsg.sendMsg("login.success", e),
                        globalMsg.sendMsg("login.change")
                    },
                    "logincb"),
                    a.regcb = s("onLogin",
                    function(e) {
                        m.ursId = e,
                        m._callback(e, "reg"),
                        globalMsg.sendMsg("reg.success", e),
                        globalMsg.sendMsg("login.success", e),
                        globalMsg.sendMsg("login.change")
                    },
                    "regcb"),
                    ...
                    function() {
                        setTimeout(function() {
                            globalMsg.sendMsg("login.giveup"),
                            globalMsg.sendMsg("reg.giveup"),
                            m._callback("", "giveup")
                        },
                        100)
                    },
                ...
                return m.ursId = m.cookie.getSInfo() ? m.cookie.getPInfo().base || "": "",
                $.extend(r, {
                    ...
                    hook: function(e, i) {
                        var m = {};
                        "string" != typeof e || !$.isFunction(i) && null !== i || (m[e] = i),
                        "object" != typeof e || $.isArray(e) || $.extend(m, e || {});
                        for (var n in t) $.isFunction(m[n]) && (t[n] = m[n])
                    },
                    setURSId: function(e) {
                        m.ursId !== e && (e ? s("onLogin",
                        function() {
                            m.ursId = e,
                            globalMsg.sendMsg("login.success", e),
                            globalMsg.sendMsg("login.change")
            ...
            login.drag = function() {
                    ...
                    if ($ && $.fn && $.fn.bindDrag && e && e[0]) {
                        ...
                        m.css("cursor", "move").bindDrag({
                            ...
                            dragEnd: function() {
                                ...
                                l = {},
                                u = function() {
                                    l.left -= +(r.marginLeft.replace(/[^\d\-\.]/g, "") || 0),
                                    l.top -= +(r.marginTop.replace(/[^\d\-\.]/g, "") || 0),
                                    e.css(r).css(l)
                                };
                                l.top = Math.max(c[0] - options.top + 5, Math.min(i.top, n[1] - (options.miniShow + options.top) + c[0])),
                                l.left = Math.min(n[0] - options.miniShow + c[1], Math.max(i.left, options.miniShow - s[0] + c[1])),
                                l.top != i.top || l.left != i.left ? e.animate(l, 200, u) : u(),
                                t.hide()
                            }
                        })
                    }
                ...
                return {
                    ...
                    init: function(e, i) {
                        var m = e || {};
                        $.each(["top", "height", "miniShow"],
                        function(e) {
                            var i = m[e];
                            isNaN(i) ? void 0 !== i && delete m[e] : m[e] = parseInt(i, 10)
                        }),
                        $.extend(options, m),
                        i || login.hook("ursInit", hookFn)
                    }
                }
            } (),
            $.login = login
            ...
            function(name, conf) {
                ...
                if (!isLowerIE) {
                    var make = function(e, i) {
                        var m, t = [];
                        for (var n in conf) m = (conf[n] + "").split(","),
                        t.push([n, "%{", m.length > 1 ? "opacity:" + m[1] + ";": "", i + ":scale(", m[0], ");", "}"].join(""));
        ...
        $.login = getHolderFn("a"),
        $.login.reg = getHolderFn("b"),
        $.login.hook = getHolderFn("c"),
        $.login.setDefaultConf = getHolderFn("d");
        var readyCache = [];
        ...
        function(e, i) {
            ...
            t.src = e,
            m.appendChild(t, m.lastChild)
        } (URSJS,
        function() {
            startAct(),
            getHolderFn.clearKey("d", $.login.setDefaultConf, $.login),
            getHolderFn.clearKey("c", $.login.hook, $.login),
            getHolderFn.clearKey("b", $.login.reg, $.login),
            getHolderFn.clearKey("a", $.login, $),
            $.each(readyCache || [],
            function(e, i) {
                i()
            }),
    ...
    function() {
        function i() {
            ...
            this.d = function(m) {
                ...
                for (var t = [], n = e[11]; n < m.length; n++) {
                    n % e[10] == e[11] && t.push("%");
                    for (var s = i,
                    r = e[11]; r < s.length; r++) if (m.charAt(n) == s[r]) {
        ...
        function() {
            ...
            function u(i, o, a) {
                ...
                if (a == e[536]) a = i[o],
                c = e[11],
                h.push(l[a >>> e[10] & e[149]]),
                h.push(l[(a << e[18] & e[118]) + (c >>> e[18] & e[52])]),
                h.push(u),
                h.push(u);
                else if (a == e[10]) a = i[o],
                c = i[o + e[536]],
                i = e[11],
                h.push(l[a >>> e[10] & e[149]]),
                h.push(l[(a << e[18] & e[118]) + (c >>> e[18] & e[52])]),
                h.push(l[(c << e[10] & e[144]) + (i >>> e[25] & e[14])]),
                h.push(u);
                else if (a == e[14]) a = i[o],
                c = i[o + e[536]],
                i = i[o + e[10]],
                h.push(l[a >>> e[10] & e[149]]),
                h.push(l[(a << e[18] & e[118]) + (c >>> e[18] & e[52])]),
            ...
            function w(i) {
                ...
                function a() {
                    function i(e) {
                        ...
                        l.appendChild(u),
                        i.height = u.offsetHeight,
                        i.width = u.offsetWidth,
                        l.removeChild(u),
                        i
                    }
                ...
                function c() {
                    ...
                    m = [];
                    try {
                        i = X.createElement(n("mCmhm2WmmhWC")),
                        e = i[n("mWmiW33CmGm2W3miWyW3")](t("WWmimsmWme")) || i[r("mWmiW33CmGm2W3miWyW3")](n("miWyWBmiWsm4m6mim2W3mhmes6WWmimsmWme"))
                    } catch(s) {}
                    if (!e) return m;
                    try {
                ...
                function l(i, t) {
                    try {
                        ...
                        return i.shaderSource(h, o),
                        i.compileShader(h),
                        i.attachShader(l, u),
                        i.attachShader(l, h),
                        i.linkProgram(l),
                        i.useProgram(l),
                        l.n = i.getAttribLocation(l, m("mhW3W3WsimmiWsW3miWy")),
                        l.m = i.getUniformLocation(l, r("Wim2m4mmmGWsm63GmmmmWCmiW3")),
                        i.enableVertexAttribArray(l.o),
                        i.vertexAttribPointer(l.n, a.k, i.FLOAT, !e[536], e[11], e[11]),
                        i.uniform2f(l.m, e[536], e[536]),
                        i.drawArrays(i.TRIANGLE_STRIP, e[11], a.l),
                        G(t[r("W3mG33mhW3mhiiis3e")]())
                    } catch(f) {
                ...
                function u() {
                    ...
                    for (var c = e[11]; c < a.length; c++) try {
                        ...
                        i.style.color = a[c],
                        o.push(a[c]),
                        o.push(window[t("mWmiW33CmGm6WBWiW3mim3iCW3W4memi")](i).getPropertyValue(m("mCmGmemGWs"))),
                ...
                function d() {
                    if (window[s("3hmCW3m4Wmmiiy3GmsmKmimCW3")]) {
                        ...
                        function(e) {
                            try {
                                return new(window[s("3hmCW3m4Wmmiiy3GmsmKmimCW3")])(e),
                                e
                            } catch(i) {
                                return null
                            }
            ...
            function G(i) {
                ...
                o = e[16];
                u = e[372];
                for (f = e[11]; f < c;) h = i.charCodeAt(f) & e[295] | (i.charCodeAt(++f) & e[295]) << e[33] | (i.charCodeAt(++f) & e[295]) << e[54] | (i.charCodeAt(++f) & e[295]) << e[70],
                ++f,
                h = (h & e[481]) * o + (((h >>> e[54]) * o & e[481]) << e[54]) & e[401],
                h = h << e[52] | h >>> e[56],
                h = (h & e[481]) * u + (((h >>> e[54]) * u & e[481]) << e[54]) & e[401],
                l ^= h,
                l = l << e[46] | l >>> e[60],
                l = (l & e[481]) * e[21] + (((l >>> e[54]) * e[21] & e[481]) << e[54]) & e[401],
                l = (l & e[481]) + e[391] + (((l >>> e[54]) + e[431] & e[481]) << e[54]);
                h = e[11];
                switch (a) {
                case e[14]:
                ...
                try {
                    ...
                    a = [],
                    a.push(i),
                    a.push(I(ei, t("s6")).join(r(""))),
                    a.push(I(ii, n("s6")).join(t("")))
                }
                return a.join(r(""))
            }
            function b(i, m) {
            ...
            function J() {
                if (! (null == Gi || void 0 == Gi || Gi.length <= e[11])) for (var i = e[11]; i < Gi.length; i++) {
                    var m = Gi[i]; (null != Bi && void 0 != Bi && Bi != n("") || null != m && void 0 != m && m != n("")) && Bi != m && (z(li, m), z(ui, m))
                }
            }
            function q() {
                J();
                ...
                try {
                    ...
                    if (null == S || void 0 == S || S.length == e[11]) M = h(si);
                        ...
                        var L = S.length,
                        O = e[11],
                        O = L % si <= si - oi ? si - L % si - oi: si * e[10] - L % si - oi,
                        $ = [];
                        f(S, e[11], $, e[11], L);
                        for (var F = e[11]; F < O; F++) $[L + F] = e[11];
                        f(W(L), e[11], $, L + O, oi);
                        M = $
                    }
                    L = M;
                    if (null == L || L.length % si != e[11]) throw Error(r("ChCBCBCi"));
                    M = [];
                    for (var P = e[11], K = L.length / si, H = e[11]; H < K; H++) {
                        M[H] = [];
                        for (var z = e[11]; z < si; z++) M[H][z] = L[P++]
                    }
                    P = [];
                    f(I, e[11], P, e[11], ai);
                    for (var Y = M.length,
                    ...
                    if (null == P || void 0 == P) yi = null;
                        ...
                        var Bi = e[14];
                        try {
                            for (var Y = [], Gi = e[11]; Gi < P.length;) if (Gi + Bi <= P.length) Y.push(u(P, Gi, Bi)),
                            Gi += Bi;
                            else {
            ...
            function() {
                ...
                if (null == e || void 0 == e || e == r("")) e = !1;
                    ...
                    var i;
                    if (i = F()) e = P(e),
                    i = !(null == e || e - (new(window[n("33mhW3mi")]))[s("mWmiW3i3m4m6mi")]() <= di - pi);
                    e = i
                }
                return e
...
var Core = function(e, i, m) {
    ...
    var c = {
        ...
        navInit: function(e, i, m, t) {
            ...
            if (this.userPage || this.privatePage) this.navConfig.logoutUrl = "http://reg.163.com/Logout.jsp?username={username}&url=" + encodeURIComponent("http://caipiao.163.com/reg/logoutredirect.html?gotoUrl=" + encodeURIComponent("http://caipiao.163.com"));
        ...
        loadGolbalConfig: function() {
            e.gameActConf ? i.sendMsg("globalConfig") : this.loadJS("http://caipiao.163.com/globalConfig.html?" + +new Date,
            function() {
        ...
        gameAct: {
                    ...
                    if (s.range) {
                        if ("server" == s.range) {
                            ...
                            if (e.gameActConf) o = f();
                                ...
                                i.isFunction(h) && i.bindMsgOnce("globalConfig",
                                function() {
                                    h(f())
                                });
                                return
            ...
            list: function(e) {
                ...
                if (!c.gameActConfig) c.loadCdnJS("js2/config.js",
                function() {
            ...
            t = function() {
                ...
                function(e, i) {
                    if (i.id && i.png && i.url) {
                        ...
                        else if (i.page & s) m.showPngAd(i, "",
                        function(e) {
        ...
        init: function() {
            ...
            n(m);
            n(t);
            i(document).delegate("a[csrf],a.csrf", "click",
            function() {
            ...
            i(document).delegate('a[href*="javascript:"]', "click",
            function(e) {
        ...
        checkGamePause: function() {
            ...
            return function(n, s) {
                ...
                t = e.setTimeout(function() {
                    s = s || i.noop;
                    c.loadCdnJS("js2/game/stopGameStatus.js",
                    function() {
        ...
        loadGame: function(m, t) {
            ...
            this.loadCdnJS("js2/game/game.js",
            function() {
        ...
        initMyCoupon: function() {
            ...
            n = function(t) {
                ...
                c = '<a target="_blank" href="http://caipiao.163.com/my/coupon.html#from=top" class="seeCoupon">查看全部<i>{couponNum}</i>个红包</a>',
                l = [],
                u = [],
                h = 0,
                f;
            ...
            s = function() {
                ...
                i.ajax({
                    url: "http://caipiao.163.com/my/topCoupon.html",
                    cache: false,
                    complete: function() {
            ...
            i("#myCoupon").delegate(".topNavHolder", "mouseenter",
            function() {
                t = e.setTimeout(function() {
                    s()
                },
                100)
            }).delegate(".topNavHolder", "mouseleave",
            function() {
                t && e.clearTimeout(t)
            });
            return this
        ...
        initNav: function() {
            ...
            n = function() {
                ...
                else c.get("http://caipiao.163.com/activity/newUserPayAds.html?memType=myordermenu",
                function(e, i) {
                    if (!e) {
                        s(i);
                        t = {
                    ...
                    if (m) {
                        ...
                        function(e, m) {
                            ...
                            function(e, t) {
                                ...
                                return (t == 2 * W[m] ? h: "") + i.format(a, i.extend({},
                                e, {
        ...
        dealKuai2: function() {
            ...
            else i.bindMsgOnce("globalConfig",
            function() {
                t(e.kuai2Display)
            });
        ...
        getEpayInfo: function() {
            ...
            m && this.get("http://caipiao.163.com/epayAccountInfo.html",
            function(e, m) {
                if (e || !m) return;
        ...
        isLogin: function(e) {
            this.get("http://caipiao.163.com/identity/queryLoginStatus.html",
            function(i, m) {
...
jQuery(window).unload(function() {
    ...
    window.onerror = null;
    window.onbeforeunload = null; (window.CollectGarbage ||
    function() {})()
});
